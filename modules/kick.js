...
module.exports.run = async (client, message, args) => {
    if(message.author === userID && !message.member.hasPermission('KICK_MEMBERS')) return message.channel.send(":interrobang: | VocÍ n„o tem permiss„o para executar esse comando!")
